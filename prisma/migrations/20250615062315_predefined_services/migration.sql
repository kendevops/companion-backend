...
-- CreateTable
CREATE TABLE "PredefinedService" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    ...
    CONSTRAINT "PredefinedService_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "PredefinedService_name_key" ON "PredefinedService"("name");
